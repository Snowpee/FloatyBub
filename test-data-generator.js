...
function generateTestChatSessions() {
  // 检查是否在开发环境中且store已暴露
      ...
      messages: [
        {
          ...
          timestamp: new Date(Date.now() - (60 - i) * 60000) // 按时间倒序
        },
        {
          id: `msg-${i}-2`,
          role: 'assistant',
          content: `这是第${i}个测试对话的AI回复`,
          timestamp: new Date(Date.now() - (60 - i) * 60000 + 1000)
        }
      ],
      createdAt: new Date(Date.now() - (60 - i) * 60000),
      updatedAt: new Date(Date.now() - (60 - i) * 60000 + 2000)
    };
...
console.log('     - generateTestChatSessions() // 生成60个测试会话');
